...
public interface IZoologico {
	...
	Boolean agregarUnVeterinarioAUnHospital(Estructura hospital, Persona personal) throws NoSePudoAgregarAlVeterinarioAlHospitalException, NoSePudoAgregarEstructuraInexistenteExcepcion,
	...
	RegistroAlimentacion cargarAlimentacion(Persona personal, Animal animal, ComidaAnimales comida, Integer cantidadComida) throws NoFueCreadoElRegistroExcepcion, NoSePudoAgregarPersonaInexistenteException, NoSePudoAgregarAnimalInexistenteException, NoSePudoAgregarPersonalInvalidoExcepcion, NoSePudoAlimentarException;
