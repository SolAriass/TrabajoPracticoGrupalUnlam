Zoológico
En este proyecto desarrollamos un sistema de gestión para un zoológico, que abarca diversas funcionalidades para asegurar el bienestar de los animales, la comodidad de los visitantes y el funcionamiento eficiente de las operaciones diarias.

El programa está preparado para la comodidad tanto de los animales como la de los visitantes, se pueden manejar diversas funcionalidades de ambos al igual que las demás personas de el zoológico.
